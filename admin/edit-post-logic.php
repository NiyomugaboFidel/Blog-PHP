...
// meke sure edit post  button was  clicked
if (isset($_POST['submit'])) {
    ...
    if(!$title) {
        $_SESSION['edit-post'] = "Couldn't update post. Invalid  from data on edit post page.";
    } elseif (!$category_id) {
        $_SESSION['edit-post'] = "Couldn't update post. Invalid form data on edit post page.";

    } elseif(!$body) {
        $_SESSION['edit-post'] = "Couldn't update post . Invalid form date on edit post page.";
     } else {
      ...
      if ($thumbnail['name']) {
        ...
        // upload thumbnail
             move_uploaded_file($thumbnail_tmp_name,$thumbnail_destination_path);
                ...
                $_SESSION['edit-post'] = "File size too big. should be less than 50mb";
            }
        } else {
            $_SESSION['edit-post'] = "File should be png, jpg ,jpeg, svg,mp4,or avi.";
        }
    }
}
    ...
    If(isset($_SESSION['edit-post'])) {
        ...
        $query = "UPDATE `posts` SET `title`='$title',`body`='$body',`thumbnail`='$thumbnail_name',
