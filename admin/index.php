...
<?php if (isset($_SESSION['ad-post-success'])) : // shows if add post was successful ?>
        <div class="alert__message success container">
            <p>
                <?= $_SESSION['ad-post-success'];
                unset($_SESSION['ad-post-success']); 
                ?>
                 </p>
        </div>
...
<?php elseif (isset($_SESSION['edit-post'])) : // shows if edit post wasNOT successful ?>
