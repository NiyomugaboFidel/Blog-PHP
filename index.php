...
$featured_query = "SELECT * FROM posts WHERE is_featured=0";
$featured_result = mysqli_query($connection, $featured_query);
$featured = mysqli_fetch_assoc($featured_result);
 
// fetch 20 posts from  table 
$query = "SELECT * FROM posts ORDER BY date_time DESC LIMIT 20";
...
<?php if(mysqli_num_rows($featured_result) == 1) : ?>
    <section class="featured">
         ...
         <div class="container featured__container">
            ...
            <div class="post__info">
                 ...
                 ?> 
                <a href="<?= ROOT_URL ?>category-post.php?id=<?= $featurd['category_id'] ?>" class="category__button"><?= $category['title']?></a>
    ...
    <section class="posts <?= $featurd ? '' : 'section__extra-margin' ?>">
